...
export default function Page() {
  return (
    <main className="p-8 max-w-5xl mx-auto">
      <h1 className="font-display text-4xl mb-2">Knowledge Base</h1>
      <p className="text-[#E5E9F2]/60 mb-8">Upload + chunk + embed knowledge base documents (1536-dim pgvector).</p>
      <EmptyState
        icon={Sparkles}
